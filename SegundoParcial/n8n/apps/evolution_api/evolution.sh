...
# Clonando el repositorio Evolution API (ya no necesario si usamos Docker)
echo "Configurando Evolution API con Docker"
...
echo ""
echo "Evolution API está corriendo en: http://localhost:8080"
echo "API Key: 429683C4C977415CAAFCCE10F7D57E11"
echo ""
echo "IMPORTANTE: Cambia la API Key en el archivo .env por una clave segura."