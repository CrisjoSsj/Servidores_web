...
export class ReservaController {
  ...
  @MessagePattern('reserva.actualizar')
  async actualizar(@Payload() data: any) {
    return this.reservaService.actualizarReserva(data.id, data);
  }

  // Endpoint para eliminar una reserva
  @MessagePattern('reserva.eliminar')
  async eliminar(@Payload() data: any) {
    return this.reservaService.eliminarReserva(data.id);
  }
  ...
  @MessagePattern('mesa.actualizar')
  async actualizarMesa(@Payload() data: any) {
    return this.reservaService.actualizarMesa(data.id, data);
  }

  // Endpoint para eliminar una mesa
  @MessagePattern('mesa.eliminar')
  async eliminarMesa(@Payload() data: any) {
    return this.reservaService.eliminarMesa(data.id);
  }
  ...
  @MessagePattern('cliente.actualizar')
  async actualizarCliente(@Payload() data: any) {
    return this.reservaService.actualizarCliente(data.id, data);
  }

  // Endpoint para eliminar un cliente
  @MessagePattern('cliente.eliminar')
  async eliminarCliente(@Payload() data: any) {
    return this.reservaService.eliminarCliente(data.id);
  }
