...
export class MenuController {
  ...
  // Actualizar plato
  @MessagePattern('plato.actualizar')
  async actualizarPlato(@Payload() data: any) {
    return this.menuService.actualizarPlato(data.id, data);
  }

  // Eliminar plato
  @MessagePattern('plato.eliminar')
  async eliminarPlato(@Payload() data: any) {
    return this.menuService.eliminarPlato(data.id);
  }
  ...
  // Actualizar menú
  @MessagePattern('menu.actualizar')
  async actualizarMenu(@Payload() data: any) {
    return this.menuService.actualizarMenu(data.id, data);
  }

  // Eliminar menú
  @MessagePattern('menu.eliminar')
  async eliminarMenu(@Payload() data: any) {
    return this.menuService.eliminarMenu(data.id);
  }
  ...
  @MessagePattern('categoria.actualizar')
  async actualizarCategoria(@Payload() data: any) {
    return this.menuService.actualizarCategoria(data.id, data);
  }

  // Eliminar categoría
  @MessagePattern('categoria.eliminar')
  async eliminarCategoria(@Payload() data: any) {
    return this.menuService.eliminarCategoria(data.id);
  }
}
